...
SOURCES = {
	...
	"AMAP" : {
		"name" : 'AMap',
		"description" : 'AutoNavi map of China (GCJ-02 coordinate system)',
		"service": 'TMS',
		"grid": 'WM',
		"quadTree": False,
		"gcj02": True,
		"layers" : {
			"STREET" : {"urlKey" : '8', "name" : 'Street', "description" : 'Road network with labels', "format" : 'png', "zmin" : 1, "zmax" : 18},
			"SAT" : {"urlKey" : '6', "name" : 'Satellite', "description" : 'Satellite imagery', "format" : 'jpeg', "zmin" : 1, "zmax" : 18}
		},
		"urlTemplate": "http://wprd01.is.autonavi.com/appmaptile?lang=zh_cn&size=1&style={LAY}&x={X}&y={Y}&z={Z}",
	...
	"TIANDITU" : {
		...
		"layers" : {
			...
			"CVA" : {"urlKey" : 'cva', "name" : 'Vector labels', "description" : 'Vector annotations (place names)', "format" : 'png', "zmin" : 1, "zmax" : 18},
			"IMG" : {"urlKey" : 'img', "name" : 'Imagery', "description" : 'Imagery base map (satellite)', "format" : 'jpeg', "zmin" : 1, "zmax" : 18},
			"CIA" : {"urlKey" : 'cia', "name" : 'Imagery labels', "description" : 'Imagery annotations', "format" : 'png', "zmin" : 1, "zmax" : 18},
